...
def init_db():
    ...
    CREATE INDEX IF NOT EXISTS idx_uploaded_files_user ON uploaded_files (user_id, session_number);
    CREATE INDEX IF NOT EXISTS idx_chat_files_chat ON chat_files (chat_history_id);
    """)
    conn.commit()
    conn.close()
