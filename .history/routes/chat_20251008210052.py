    ...
    if current_user:
        ...
        if hasattr(current_app, 'file_cache') and cache_key in current_app.file_cache:
            ...
            try:
                ...
                files = conn.execute(
                    f"""SELECT id, stored_name, original_name, size, mime_type, is_image
                       FROM uploaded_files
                ...
                for file_record in files:
                    file_path = os.path.join(user_dir, file_record['stored_name'])
                    ...
                    if file_record['is_image']:
                        ...
                        content = extract_file_content(file_path, file_record['mime_type'])
                    ...
                    if current_user and file_data_list:
                        ...
                        try:
                            ...
                            for file_data in file_data_list:
                                conn.execute(
                                    "INSERT INTO chat_files (chat_history_id, file_id) VALUES (?, ?)",
